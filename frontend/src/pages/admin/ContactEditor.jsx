...
const ContactEditor = () => {
    ...
    const fetchContent = async () => {
        setLoading(true);
        try {
            const response = await axiosClient.get('/api/page-contents?page=contact', { skipLoading: true });
    ...
    const addSocial = () => {
        setOfficeInfo({
            ...officeInfo,
            socials: [...officeInfo.socials, { platform: 'facebook', value: '', visible: true }]
        });
    };
            ...
            <div className="bg-white p-6 rounded-lg shadow space-y-8">
                        ...
                        <div className="flex justify-between items-center mb-1">
                            ...
                            <div className="flex items-center gap-2">
                                <input 
                                    ...
                                    onChange={(e) => setOfficeInfo({ ...officeInfo, email: { ...officeInfo.email, visible: e.target.checked } })}
                                    className="rounded text-blue-600 focus:ring-blue-500"
                                />
                                <label htmlFor="email-visible" className="text-sm text-gray-600 cursor-pointer select-none">Show on website</label>
                            </div>
                        </div>
                        <input
                            type="email"
                            ...
                            onChange={(e) => setOfficeInfo({ ...officeInfo, email: { ...officeInfo.email, value: e.target.value } })}
                            ...
                            <div className="flex justify-between items-center mb-1">
                                ...
                                <div className="flex items-center gap-2">
                                    <input 
                                        ...
                                        onChange={(e) => setOfficeInfo({ ...officeInfo, mobile: { ...officeInfo.mobile, visible: e.target.checked } })}
                                        className="rounded text-blue-600 focus:ring-blue-500"
                                    />
                                    <label htmlFor="mobile-visible" className="text-sm text-gray-600 cursor-pointer select-none">Show</label>
                                </div>
                            </div>
                            <input
                                type="text"
                                ...
                                onChange={(e) => setOfficeInfo({ ...officeInfo, mobile: { ...officeInfo.mobile, value: e.target.value } })}
                            ...
                            <div className="flex justify-between items-center mb-1">
                                ...
                                <div className="flex items-center gap-2">
                                    <input 
                                        ...
                                        onChange={(e) => setOfficeInfo({ ...officeInfo, landline: { ...officeInfo.landline, visible: e.target.checked } })}
                                        className="rounded text-blue-600 focus:ring-blue-500"
                                    />
                                    <label htmlFor="landline-visible" className="text-sm text-gray-600 cursor-pointer select-none">Show</label>
                                </div>
                            </div>
                            <input
                                type="text"
                                ...
                                onChange={(e) => setOfficeInfo({ ...officeInfo, landline: { ...officeInfo.landline, value: e.target.value } })}
                ...
                <div>
                    ...
                    {officeInfo.socials.length === 0 ? (
                        <p className="text-gray-500 text-sm italic text-center py-4 bg-gray-50 rounded">No social media links added yet.</p>
                    ) : (
                                ...
                                <div key={index} className="flex gap-3 items-start bg-gray-50 p-3 rounded border border-gray-100">
                                    ...
                                    <div className="flex items-center gap-2 pt-2">
                                        <input 
                                            ...
                                            onChange={(e) => handleSocialChange(index, 'visible', e.target.checked)}
                                            className="rounded text-blue-600 focus:ring-blue-500"
